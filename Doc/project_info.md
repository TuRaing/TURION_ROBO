...
3. **Result:** Gudi Padwa, Ganesh Chaturthi, Janmashtami, Dussehra, Sankashti Chaturthi all confirmed exact against real dates (Sankashti specifically confirmed correct by the builder directly, from personal knowledge). Raksha Bandhan remains 1 day off (27 vs. real 28 Aug) — an accepted residual gap, not chased further.
...
5. **Not attempted:** full traditional kshaya/adhika-tithi resolution rules (different panchang traditions have different conventions for which day "owns" a skipped or doubled tithi) — the multi-check safety net is a practical approximation, not a rules-accurate implementation. Revisit if a specific date is ever reported wrong again.
